...
- name: create LUKS container with luks1 type
  luks_device_reloaded:
    device: "/dev/loop0"
    state: "present"
    type: 'luks1
...
def run_module():
    ...
    module_args = dict(
        ...
        type=dict(type='str', default='luks', choices=['luks', 'luks1', 'luks2']),
    ...
    if conditions.luks_create():
        if not module.check_mode:
            try:
                ...
                module.fail_json(msg="luks_device_reloaded error: %s" % e)
        result['changed'] = True
